            ...
            <div class="address-section-wrapper">
              ...
              <div class="address-list-container">
                <transition-group name="list-anim">
                  <div v-for="(addr, index) in editForm.listDiaChi" :key="'addr-' + index"
                    ...
                    <div class="address-main-row">
                      ...
                      <div class="addr-detail-col">
                        <input v-model="addr.detail" class="addr-input-detail form-input" placeholder="Số nhà, đường..."
...
.address-main-row {
  display: flex;
  gap: 12px;
  /* Tăng khoảng cách ra một chút cho đẹp */
  align-items: center;
  margin-bottom: 15px;
  flex-wrap: nowrap;
  /* 👉 ĐỔI THÀNH nowrap ĐỂ ÉP TRÊN 1 DÒNG */
  padding-right: 36px;
