    ...
    <div class="a4-page">
      ...
      <div class="title-container">
        <div class="title-left">
          ...
          <p class="invoice-serial">
            Mã số: <strong>{{ invoice.maHoaDon }}</strong>
          </p>
          <p class="invoice-date">Ngày: {{ formatDate(invoice.ngayTao) }}</p>
        </div>
        <div class="qr-right">
          <img
            :src="`https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=${invoice.maHoaDon}`"
            alt="QR"
          />
        </div>
      </div>
      ...
      <div class="customer-section">
        <div class="row-info">
          ...
          <span class="value uppercase"
            ><strong>{{ invoice.tenKhachHang }}</strong></span
          >
        </div>
        <div class="row-info">
        ...
        <div class="row-info">
          ...
          <span class="value">{{
            invoice.diaChi || "Khách mua tại quầy"
          }}</span>
        </div>
        <div class="row-info">
      ...
      <div class="footer-wrapper">
        <div class="summary-section">
          ...
          <div class="sum-row">
            <span class="sum-label">
              Giảm giá:
              <span v-if="invoice.maVoucher" class="voucher-badge">{{
                invoice.maVoucher
              }}</span>
            </span>
            <span class="sum-value"
        ...
        <div class="thank-you">
          ...
          <p style="font-size: 11px; color: #555">
            (Hóa đơn là chứng từ bảo hành, vui lòng giữ lại trong vòng 3 ngày
            đổi trả)
          </p>
        </div>
      </div>
...
@media print {
  ...
  /* ĐÃ SỬA: Thêm căn giữa theo chiều dọc cho nhãn và số tiền */
  .sum-row {
    display: flex;
    justify-content: space-between;
    align-items: center;
  ...
  /* ĐÃ THÊM: CSS cho viền mã voucher */
  .voucher-badge {
